...
def check_play_button(ai_settings, screen, stats, sb, play_button, ship, aliens, bullets, mouse_x, mouse_y):
    """Starts a new game when the player press the play button"""
    button_clicked = play_button.rect.collidepoint(mouse_x, mouse_y)
    if button_clicked and not stats.game_active:
        # Reset the game setting.
        ai_settings.initialize_dynamic_settings()
        # Hide the mouse while the game is playing.
...
def check_bullet_alien_collision(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    # if collided, removes the aliens and bullets that have collided.
...
def get_number_aliens_x(ai_settings, alien_width):
    '''Determine the number of alien that fits in a row.'''
...
def create_fleet(ai_settings, screen, ship, aliens):
    ...
    #create an alien and find the number of fleet in a row.
...
def check_fleet_edges(ai_settings, aliens):
    """respond if an alien have reached an edge"""
...
def check_aliens_bottom(ai_settings, stats, sb, screen, ship, aliens, bullets):
    """Checks to see if an aliens reaches the bottom of the screen."""
